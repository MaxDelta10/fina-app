...
export const deleteTransactionDeclaration: FunctionDeclaration = {
  ...
  description:
    "Delete an existing transaction form user's financial history based on the provided data.",
  parameters: {
    type: Type.OBJECT,
    properties: transactionProperties,
  },
...
export const updateTransactionDeclaration: FunctionDeclaration = {
  ...
  description:
    "Update an existing transaction form user's financial history based on the provided data.",
  parameters: {
    type: Type.OBJECT,
    properties: transactionProperties,
  },
